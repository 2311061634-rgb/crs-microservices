# Thiết Kế Biên Giới Service - Dự Án CRS Microservices
...
- **Độc lập Database:** Mỗi service có DATABASE RIÊNG, KHÔNG service nào được truy cập trực tiếp DB của service khác.
- **Giao tiếp qua REST API:** Muốn lấy/thay đổi dữ liệu của service khác PHẢI gọi REST API sang service đó.
